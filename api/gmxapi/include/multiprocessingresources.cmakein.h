...
{
public:
    virtual ~MultiProcessingResources();
 ...
 *
 * Helper function allowing clients to provide
 * communicator to library.
 * \param communicator
 *
 */
 ...
 * Clients should use the lendCommunicator() higher level function in explicit code,
