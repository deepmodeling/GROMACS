...
std::array<int, 2> nblibOrdering(const std::array<int, 2>& t)
{
...
std::array<int, 3> nblibOrdering(const std::array<int, 3>& t)
{
...
std::array<int, 4> nblibOrdering(const std::array<int, 4>& t)
{
    return t;
}

//! Tuple ordering for five center interactions
std::array<int, 5> nblibOrdering(const std::array<int, 5>& t)
{
    return t;
}
