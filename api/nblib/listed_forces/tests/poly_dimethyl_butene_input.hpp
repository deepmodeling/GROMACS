...
private:
    ...
    void setInteractionParameters()
    {
        ...
        DefaultAngle angle1{Degrees(phi), 100};
        DefaultAngle angle2{Degrees(phi), 200};
        std::array<DefaultAngle, 2> anglesp{angle1, angle2};
        ...
        {
            auto& p = pickType<DefaultAngle>(interactions).parameters;
    ...
    void addBulk(int i)
    {
        ...
        auto& angles    = pickType<DefaultAngle>(interactions);
