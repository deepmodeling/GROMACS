...
Reduce possibility for Floating Point Exceptions (FPE) in random number generator
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

The random number generator could generate floating point exceptions when using
the gamma distribution by either dividing by zero or taking the logarithm of
zero under certain corner case conditions.
