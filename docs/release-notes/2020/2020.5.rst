...
The random number generator could generate floating point exceptions by either dividing
by zero or taking the logarithm of zero under certain corner case conditions.
