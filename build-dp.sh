...
mkdir build;
cd build; 
cmake .. -DGMX_MPI=ON -DGMX_GPU=CUDA -DCUDA_TOOLKIT_ROOT_DIR=/data2/publicsoft/cuda10.0 -DCMAKE_INSTALL_PREFIX=/data1/anguse/yuxuan/bin/gromacs-2021.dp -DREGRESSIONTESTS_DOWNLOAD=OFF -DREGRESSIONTEST_PATH=/data1/anguse/yuxuan/regressiontests-2021.1 && make -j 8 &&  make check && make install
