  ...
  if(MPI_FOUND)
    ...
    if(NOT GMX_CUDA_AWARE_MPI STREQUAL "OFF" AND GMX_GPU_CUDA)
      ...
      if(GMX_CUDA_AWARE_MPI STREQUAL "ON" AND CUDA_AWARE_MPI_SUPPORTED EQUAL 0)
        MESSAGE(FATAL_ERROR "GMX_CUDA_AWARE_MPI was set to ON but, MPI implementation isn't CUDA-aware.")
        set(CUDA_AWARE_MPI 0)
      elseif(GMX_CUDA_AWARE_MPI STREQUAL "ON")
        if(CUDA_AWARE_MPI_SUPPORTED EQUAL 2)
          MESSAGE(WARNING "GMX_CUDA_AWARE_MPI was set to ON, please make sure MPI implementation is CUDA-aware.")
        endif()
        set(CUDA_AWARE_MPI 1)
      elseif(GMX_CUDA_AWARE_MPI STREQUAL "AUTO" AND CUDA_AWARE_MPI_SUPPORTED EQUAL 1)
        MESSAGE(STATUS "Enabled CUDA-aware MPI")
        set(CUDA_AWARE_MPI 1)
      else()
        MESSAGE(STATUS "Disabled CUDA-aware MPI")
        set(CUDA_AWARE_MPI 0)
      endif()
    else()
      # Don't check anything if user has not requested for CUDA-aware MPI
      set(CUDA_AWARE_MPI 0)
      set(MPIEXT_HEADER_AVAILABLE 0)
    endif()
    ...
    if (MPI_INFO_BIN)
      ...
      if(OPENMPI_EXEC_RETURN EQUAL 0)
        ...
        if(CUDA_AWARE_MPI AND OPENMPI_VERSION VERSION_LESS "1.7.0")
          MESSAGE(FATAL_ERROR "This OpenMPI version isn't CUDA-aware.")
        endif()
    ...
    if (MPINAME_BIN)
      ...
      if(MVAPICH2_EXEC_RETURN EQUAL 0)
       ...
       if(CUDA_AWARE_MPI AND ${MVAPICH2_NAME} STREQUAL "MVAPICH2" AND MVAPICH2_VERSION VERSION_LESS "1.9")
          MESSAGE(FATAL_ERROR "This MVAPICH2 version isn't CUDA-aware.")
       endif()
