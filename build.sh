...
mkdir build;
cd build; 
cmake .. -DGMX_MPI=ON -DGMX_GPU=ON -DCUDA_TOOLKIT_ROOT_DIR=/data2/publicsoft/cuda10.0 -DCMAKE_INSTALL_PREFIX=/data1/anguse/zijian/gromacs-2020.2-gpuall-bonded && make -j install
