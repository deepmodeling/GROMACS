...
constexpr double EPSI0 = (gmx::EPSILON0 * gmx::E_CHARGE * gmx::E_CHARGE * gmx::AVOGADRO
                          / (gmx::KILO * gmx::NANO)); /* EPSILON0 in SI units */
                       ...
                       const gmx_output_env_t* oenv)
{
    ...
    prefactor = 1.0;
    prefactor /= 3.0 * gmx::EPSILON0 * volume_av * gmx::BOLTZ * temp;


    prefactorav = gmx::E_CHARGE * gmx::E_CHARGE;
    prefactorav /= volume_av * gmx::BOLTZMANN * temp * gmx::NANO * 6.0;
    ...
    if (v0 != nullptr)
    {
        ...
        if (bACF)
        {
            ...
            sgk = calc_cacf(outf, prefactorav / gmx::PICO, cacf, time, nvfr, vfr, ie, nshift);
