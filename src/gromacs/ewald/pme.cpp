                        ...
                        const gmx::MDLogger& /*mdlog*/)
{
    ...
    if (pme_gpu_active(pme.get()))
    {
        ...
        pme_gpu_reinit(pme.get(), gpuInfo, pmeGpuProgram, ir->efep != efepNO, ir->fepvals->init_lambda_q);
    }
                    ...
                    real               ewaldcoeff_lj)
{
    ...
    irc.fepvals->init_lambda_q = ir->fepvals->all_lambda[efptCOUL][ir->fepvals->init_fep_state];
