...
GpuParallel3dFft::GpuParallel3dFft(const PmeGpu* pmeGpu, const int gridIndex)
{
    ...
    std::array<size_t, gmx::c_dim> realGridDimensions = { realGridSize[ZZ],
                                                          realGridSize[YY],
                                                          realGridSize[XX] };
    std::array<size_t, gmx::c_dim> realGridStrides    = {
        1, realGridSizePadded[ZZ], realGridSizePadded[YY] * realGridSizePadded[ZZ]
    };
