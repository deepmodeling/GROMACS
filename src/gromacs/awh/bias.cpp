                                                         ...
                                                         FILE*                  fplog)
{
    ...
    if (params_.convolveForce || moveUmbrella || sampleCoord)
    {
        ...
        convolvedBias = state_.updateProbabilityWeightsAndConvolvedBias(
                dimParams_, grid_, neighborLambdaEnergies, &probWeightNeighbor);
    ...
    *potentialJump = 0;
    ...
    {
        state_.calcConvolvedForce(dimParams_, grid_, probWeightNeighbor, neighborLambdaDhdl,
    ...
    else
    {
        ...
        potential = state_.calcUmbrellaForceAndPotential(
                dimParams_, grid_, coordState.umbrellaGridpoint(), neighborLambdaDhdl, biasForce_);
    ...
    if (sampleCoord && params_.convolveForce && grid_.hasLambdaAxis())
    {
...
bool Bias::isLambdaDim(int dim) const
{
    ...
    return dimParams_[dim].isLambdaDimension();
}
