 ...
 *
 * \param[in] kk     present value of the kinetic energy of the atoms to be thermalized (in arbitrary units)
 * \param[in] sigma  target average value of the kinetic energy (ndeg k_b T/2)  (in the same units as kk)
 * \param[in] ndeg   number of degrees of freedom of the atoms to be thermalized
 * \param[in] taut   relaxation time of the thermostat, in units of 'how often this routine is called'
