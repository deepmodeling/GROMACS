...
#define ANGLE_6RING (gmx::DEG2RAD * 120)
...
#define NMASS 2
    ...
    a_NE1_CE2_CD2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "NE1", "CE2", "CD2");
    a_CE2_CD2_CG  = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CE2", "CD2", "CG");
    a_CB_CG_CD2   = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CB", "CG", "CD2");
    a_CD2_CG_CD1  = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CD2", "CG", "CD1");

    a_CE2_CD2_CE3 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CE2", "CD2", "CE3");
    a_CD2_CE2_CZ2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CD2", "CE2", "CZ2");
    a_CD2_CE3_CZ3 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CD2", "CE3", "CZ3");
    a_CE3_CZ3_HZ3 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CE3", "CZ3", "HZ3");
    a_CZ2_CH2_HH2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CZ2", "CH2", "HH2");
    a_CE2_CZ2_HZ2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CE2", "CZ2", "HZ2");
    a_CE2_CZ2_CH2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CE2", "CZ2", "CH2");
    a_CG_CD1_HD1  = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CG", "CD1", "HD1");
    a_HE1_NE1_CE2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "HE1", "NE1", "CE2");
    a_CD2_CE3_HE3 = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TRP", "CD2", "CE3", "HE3");
                          ...
                          gmx::ArrayRef<const VirtualSiteTopology> vsitetop)
{
    ...
    angle_coh = gmx::DEG2RAD * get_ddb_angle(vsitetop, "TYR", "CZ", "OH", "HH");
                          ...
                          gmx::ArrayRef<const VirtualSiteTopology> vsitetop)
{
    ...
    a_CG_ND1_CE1  = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "CG", "ND1", "CE1");
    a_CG_CD2_NE2  = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "CG", "CD2", "NE2");
    a_ND1_CE1_NE2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "ND1", "CE1", "NE2");
    a_CE1_NE2_CD2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "CE1", "NE2", "CD2");

    if (ats[atHD1] != NOTSET)
    {
        b_ND1_HD1     = get_ddb_bond(vsitetop, resname, "ND1", "HD1");
        a_CE1_ND1_HD1 = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "CE1", "ND1", "HD1");
    }
    if (ats[atHE2] != NOTSET)
    {
        b_NE2_HE2     = get_ddb_bond(vsitetop, resname, "NE2", "HE2");
        a_CE1_NE2_HE2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "CE1", "NE2", "HE2");
    }
    if (ats[atHD2] != NOTSET)
    {
        b_CD2_HD2     = get_ddb_bond(vsitetop, resname, "CD2", "HD2");
        a_NE2_CD2_HD2 = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "NE2", "CD2", "HD2");
    }
    if (ats[atHE1] != NOTSET)
    {
        b_CE1_HE1     = get_ddb_bond(vsitetop, resname, "CE1", "HE1");
        a_NE2_CE1_HE1 = gmx::DEG2RAD * get_ddb_angle(vsitetop, resname, "NE2", "CE1", "HE1");
    }
