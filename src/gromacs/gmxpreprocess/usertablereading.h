 ...
 *
 * \brief
 * This file contains the function declaration for reading VdW user tables from files
 *
 * \author Berk Hess
 *
 * \inlibraryapi
...
#ifndef GMX_GMXPREPROCESS_USERTABLEREADING_H
...
#endif // GMX_GMXPREPROCESS_USERTABLEREADING_H
