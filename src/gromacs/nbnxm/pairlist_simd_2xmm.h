                                         ...
                                         NbnxnPairlistCpuWork* work)
{
    ...
    int ia = xIndexFromCi<NbnxnLayout::Simd2xNN>(ci);
                                           ...
                                           int* gmx_restrict numDistanceChecks)
{
    ...
    gmx_bool InRange = FALSE;
    while (!InRange && jclusterFirst <= jclusterLast)
    {
        float d2 = clusterBoundingBoxDistance2(bb_ci[0], jGrid.jBoundingBoxes()[jclusterFirst]);
        *numDistanceChecks += 2;
        ...
        {
            int xind_f = xIndexFromCj<NbnxnLayout::Simd2xNN>(
    ...
    {
        float d2 = clusterBoundingBoxDistance2(bb_ci[0], jGrid.jBoundingBoxes()[jclusterLast]);
        *numDistanceChecks += 2;
        ...
        {
            int xind_l = xIndexFromCj<NbnxnLayout::Simd2xNN>(
