...
/* Prune-only kernels */
#include "nbnxm_fep_cuda_kernel_pruneonly.cuh"
...
#    include "nbnxm_fep_cuda_kernel_F_noprune.cu"
#    include "nbnxm_fep_cuda_kernel_F_prune.cu"
#    include "nbnxm_fep_cuda_kernel_VF_noprune.cu"
#    include "nbnxm_fep_cuda_kernel_VF_prune.cu"
#    include "nbnxm_fep_cuda_kernel_pruneonly.cu"
...
static const nbnxn_cu_kfunc_ptr_t nb_kfunc_noener_prune_ptr[eelCuNR][evdwCuNR] = {
    { nbnxm_fep_kernel_ElecCut_VdwLJ_F_prune_cuda, nbnxm_fep_kernel_ElecCut_VdwLJCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecCut_VdwLJCombLB_F_prune_cuda, nbnxm_fep_kernel_ElecCut_VdwLJFsw_F_prune_cuda,
      nbnxm_fep_kernel_ElecCut_VdwLJPsw_F_prune_cuda, nbnxm_fep_kernel_ElecCut_VdwLJEwCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecCut_VdwLJEwCombLB_F_prune_cuda },
    { nbnxm_fep_kernel_ElecRF_VdwLJ_F_prune_cuda, nbnxm_fep_kernel_ElecRF_VdwLJCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecRF_VdwLJCombLB_F_prune_cuda, nbnxm_fep_kernel_ElecRF_VdwLJFsw_F_prune_cuda,
      nbnxm_fep_kernel_ElecRF_VdwLJPsw_F_prune_cuda, nbnxm_fep_kernel_ElecRF_VdwLJEwCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecRF_VdwLJEwCombLB_F_prune_cuda },
    { nbnxm_fep_kernel_ElecEwQSTab_VdwLJ_F_prune_cuda, nbnxm_fep_kernel_ElecEwQSTab_VdwLJCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTab_VdwLJCombLB_F_prune_cuda, nbnxm_fep_kernel_ElecEwQSTab_VdwLJFsw_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTab_VdwLJPsw_F_prune_cuda, nbnxm_fep_kernel_ElecEwQSTab_VdwLJEwCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTab_VdwLJEwCombLB_F_prune_cuda },
    { nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJ_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJFsw_F_prune_cuda, nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJPsw_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_F_prune_cuda },
    { nbnxm_fep_kernel_ElecEw_VdwLJ_F_prune_cuda, nbnxm_fep_kernel_ElecEw_VdwLJCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEw_VdwLJCombLB_F_prune_cuda, nbnxm_fep_kernel_ElecEw_VdwLJFsw_F_prune_cuda,
      nbnxm_fep_kernel_ElecEw_VdwLJPsw_F_prune_cuda, nbnxm_fep_kernel_ElecEw_VdwLJEwCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEw_VdwLJEwCombLB_F_prune_cuda },
    { nbnxm_fep_kernel_ElecEwTwinCut_VdwLJ_F_prune_cuda, nbnxm_fep_kernel_ElecEwTwinCut_VdwLJCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJCombLB_F_prune_cuda, nbnxm_fep_kernel_ElecEwTwinCut_VdwLJFsw_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJPsw_F_prune_cuda, nbnxm_fep_kernel_ElecEwTwinCut_VdwLJEwCombGeom_F_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJEwCombLB_F_prune_cuda }
};

/*! Force + energy + pruning kernel function pointers. */
static const nbnxn_cu_kfunc_ptr_t nb_kfunc_ener_prune_ptr[eelCuNR][evdwCuNR] = {
    { nbnxm_fep_kernel_ElecCut_VdwLJ_VF_prune_cuda, nbnxm_fep_kernel_ElecCut_VdwLJCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecCut_VdwLJCombLB_VF_prune_cuda, nbnxm_fep_kernel_ElecCut_VdwLJFsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecCut_VdwLJPsw_VF_prune_cuda, nbnxm_fep_kernel_ElecCut_VdwLJEwCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecCut_VdwLJEwCombLB_VF_prune_cuda },
    { nbnxm_fep_kernel_ElecRF_VdwLJ_VF_prune_cuda, nbnxm_fep_kernel_ElecRF_VdwLJCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecRF_VdwLJCombLB_VF_prune_cuda, nbnxm_fep_kernel_ElecRF_VdwLJFsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecRF_VdwLJPsw_VF_prune_cuda, nbnxm_fep_kernel_ElecRF_VdwLJEwCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecRF_VdwLJEwCombLB_VF_prune_cuda },
    { nbnxm_fep_kernel_ElecEwQSTab_VdwLJ_VF_prune_cuda, nbnxm_fep_kernel_ElecEwQSTab_VdwLJCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTab_VdwLJCombLB_VF_prune_cuda, nbnxm_fep_kernel_ElecEwQSTab_VdwLJFsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTab_VdwLJPsw_VF_prune_cuda, nbnxm_fep_kernel_ElecEwQSTab_VdwLJEwCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTab_VdwLJEwCombLB_VF_prune_cuda },
    { nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJ_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJFsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJPsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_VF_prune_cuda },
    { nbnxm_fep_kernel_ElecEw_VdwLJ_VF_prune_cuda, nbnxm_fep_kernel_ElecEw_VdwLJCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEw_VdwLJCombLB_VF_prune_cuda, nbnxm_fep_kernel_ElecEw_VdwLJFsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEw_VdwLJPsw_VF_prune_cuda, nbnxm_fep_kernel_ElecEw_VdwLJEwCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEw_VdwLJEwCombLB_VF_prune_cuda },
    { nbnxm_fep_kernel_ElecEwTwinCut_VdwLJ_VF_prune_cuda, nbnxm_fep_kernel_ElecEwTwinCut_VdwLJCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJCombLB_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJFsw_VF_prune_cuda, nbnxm_fep_kernel_ElecEwTwinCut_VdwLJPsw_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJEwCombGeom_VF_prune_cuda,
      nbnxm_fep_kernel_ElecEwTwinCut_VdwLJEwCombLB_VF_prune_cuda }
};

/*! Return a pointer to the kernel version to be executed at the current step. */
static inline nbnxn_cu_kfunc_ptr_t select_nbnxm_fep_kernel(int                     eeltype,
                                                       int                     evdwtype,
                                                       bool                    bDoEne,
                                                       bool                    bDoPrune,
...
void gpu_launch_kernel(gmx_nbnxn_cuda_t* nb, const gmx::StepWorkload& stepWork, const InteractionLocality iloc)
{
    ...
    const auto kernel      = select_nbnxm_fep_kernel(
...
void gpu_launch_kernel_pruneonly(gmx_nbnxn_cuda_t* nb, const InteractionLocality iloc, const int numParts)
{
    ...
    const auto     kernel =
            plist->haveFreshList ? nbnxm_fep_kernel_prune_cuda<true> : nbnxm_fep_kernel_prune_cuda<false>;
