...
static int getCoulkt(const Nbnxm::KernelSetup& kernelSetup, const interaction_const_t& ic)
{
...
static int getVdwkt(const Nbnxm::KernelSetup&       kernelSetup,
                    ...
                    const interaction_const_t&      ic)
{
    if (ic.vdwtype == evdwCUT)
    {
        switch (ic.vdw_modifier)
        {
            ...
            default: gmx_incons("Unsupported VdW interaction modifier");
        }
    }
                             ...
                             gmx_wallcycle*             wcycle)
{
    ...
    const int                       coulkt     = getCoulkt(kernelSetup, ic);
    const int                       vdwkt      = getVdwkt(kernelSetup, nbatParams, ic);
