...
#    endif
...
#endif
            {
                ...
                const real rinvsix = interact * rinvsq * rinvsq * rinvsq;
                FrLJ6              = c6 * rinvsix;
...
#    elif defined LJ_EWALD_COMB_LB
                    ...
                    const real c6grid     = epsilon * sigma2 * sigma2 * sigma2;
#    else
...
#    endif
                ...
                {
                    const real skipmask_rvdw = (rsq < rvdw2) ? 1.0 : 0.0;
                    frLJ *= skipmask_rvdw;
#    ifdef CALC_ENERGIES
                    VLJ *= skipmask_rvdw;
#    endif
