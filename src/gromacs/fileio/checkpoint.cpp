                            ...
                            bool                                  useModularSimulator)
{
    ...
    *init_fep_state = state->fep_state; /* there should be a better way to do this than setting it
    ...
    do_cpt_mdmodules(headerContents->file_version, fp, checkpointNotifier, nullptr);
                                                     ...
                                                     gmx::ReadCheckpointDataHolder* modularSimulatorCheckpointData)
{
    ...
    do_cpt_mdmodules(headerContents.file_version, fp, checkpointingNotifier, nullptr);
    if (headerContents.file_version >= cptv_ModularSimulator)
    {
...
void list_checkpoint(const char* fn, FILE* out)
{
    ...
    gmx::CheckpointingNotification checkpointingNotification;
    do_cpt_mdmodules(headerContents.file_version, fp, checkpointingNotification, out);
    if (headerContents.file_version >= cptv_ModularSimulator)
    {
        gmx::FileIOXdrSerializer      serializer(fp);
        gmx::ReadCheckpointDataHolder modularSimulatorCheckpointData;
