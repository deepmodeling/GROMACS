...
void gmx_tng_prepare_md_writing(gmx_tng_trajectory_t gmx_tng, const gmx_mtop_t* mtop, const t_inputrec* ir)
{
    ...
    tng_time_per_frame_set(gmx_tng->tng, ir->delta_t * gmx::PICO);
...
#    endif
    double  elapsedSeconds = elapsedPicoSeconds * gmx::PICO;
    int64_t nParticles;
    char    compression;
...
real getDistanceScaleFactor(gmx_tng_trajectory_t in)
{
    ...
    switch (exp)
    {
        case 9: distanceScaleFactor = gmx::NANO / gmx::NANO; break;
        case 10: distanceScaleFactor = gmx::NANO / gmx::ANGSTROM; break;
