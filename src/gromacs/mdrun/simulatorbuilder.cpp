...
std::unique_ptr<ISimulator> SimulatorBuilder::build(bool useModularSimulator)
{
    ...
    if (useModularSimulator)
    {
        ...
        return std::unique_ptr<ModularSimulator>(new ModularSimulator(std::make_unique<LegacySimulatorData>(
                ...
                constraintsParam_->enforcedRotation, boxDeformation_->deform, simulatorModules_->outputProvider,
                simulatorModules_->mdModulesNotifier, simulatorModules_->checkpointingNotification,
